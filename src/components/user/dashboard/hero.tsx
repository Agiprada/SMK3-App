...
export default function Hero() {
  return (
    <div className='w-full m-auto bg-white px-5 mt-8'>
        <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0">
            <div className='flex flex-col bg-gray-200 justify-start gap-4 px-6 '>
                ...
                <button className="p-3 w-1/2 text-center text-white items-center rounded-3xl bg-red-500 mt-16">Gabung Sekarang</button>
            </div>
